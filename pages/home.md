        ...
        <tr style="v-align: bottom;">
            <td>
                ...
                <a href="https://sfg.taxonworks.org/tasks/otus/browse?otu_id=893674"><i>Taeniopteryx
                        burksi</i></a>
                <!-- <a href="{{ap:project_url}}/otu/893674/overview"  -->
            </td>
            <td>
                ...
                <!-- <a href="{{ap:project_url}}/otu/895443/overview"  -->
            </td>
            <td>
                ...
                <!-- <a href="{{ap:project_url}}/otu/895760/overview"  -->
            </td>
            <td>
                ...
                <!-- <a href="{{ap:project_url}}/otu/896854/overview"  -->
            </td>
        </tr>
    </tbody>
</table>
